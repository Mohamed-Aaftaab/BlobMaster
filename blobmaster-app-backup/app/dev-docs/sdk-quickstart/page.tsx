    ...
    <article className="max-w-3xl mx-auto px-6 md:px-10 py-10 lg:px-12 lg:py-14 text-zinc-400 leading-relaxed">
      ...
      <section id="prerequisites" className="scroll-mt-28 py-10">
        ...
        <ul className="list-disc list-inside space-y-2 text-zinc-400 text-sm marker:text-zinc-600">
          ...
          <li>A <span className="text-zinc-200">Sui calibration</span> blob ID you are allowed to renew (client wallet matches your key).</li>
          <li>
...
# Optional: override hosted API (defaults to calibration BlobMaster API in the SDK)
# STORKEEP_API_URL=https://api.calibration.blobmaster.xyz`}</pre>
...
npx tsx examples/blob-health-worker.ts YOUR_DEAL_ID --renew`}</pre>
      ...
      <section id="try-other" className="scroll-mt-28 py-10 border-t border-zinc-800/80">
        ...
        <ul className="list-disc list-inside space-y-3 text-zinc-400 text-sm marker:text-zinc-600">
          ...
          <li>
            <span className="text-zinc-200">Store bytes on Sui</span> (Synapse) with <code className="font-mono text-xs text-zinc-400">store</code> / <code className="font-mono text-xs text-zinc-400">retrieve</code> / <code className="font-mono text-xs text-zinc-400">prune</code>.
          </li>
        </ul>
      </section>
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="text-zinc-400 divide-y divide-zinc-800">
              ...
              <tr>
                ...
                <td className="p-3">Application data on Sui via Synapse.</td>
              </tr>
              <tr>
