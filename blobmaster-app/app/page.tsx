    ...
    <main className="min-h-[85vh] flex flex-col items-center justify-center text-center relative overflow-hidden">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-16 relative z-10 flex flex-col items-center">
        ...
        <p className="text-xl md:text-2xl text-neutral-400 mb-12 max-w-3xl leading-relaxed">
          ...
          an AI agent deposits USDC once, and every blob
      ...
      <section className="w-full max-w-5xl mx-auto px-6 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { step: '02', title: 'Extend on demand', desc: 'extendBlob() signs $0.001 USDC via x402. No MetaMask. No popup. Receipt stored on SUI.', cost: '$0.001 USDC', color: 'from-zinc-400 to-zinc-600' },
            { step: '03', title: 'Set and forget', desc: 'enableAutopilot() registers monitoring. BlobMaster extends before expiry automatically.', cost: '$0.001 USDC', color: 'from-neutral-200 to-neutral-400' },
          ].map(item => (
...
<span className="text-[#666]">// Done. $0.001 USDC charged from wallet automatically on each extension.</span>
            </pre>
          </div>
        </div>
      </section>
